...
int signal_l2(uint32_t address_low, uint32_t data_high, uint32_t data_low, int way,
	uint8_t command);
int read_l2(uint32_t address);
int write_l2(uint32_t address, uint32_t data);
int test_l2_address_alias(uint32_t address1, uint32_t address2, uint32_t data_high,
	uint32_t data_low);
